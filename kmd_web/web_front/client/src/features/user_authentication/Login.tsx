...
export default function Login() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // You can make this more specific depending on your auth error shape
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center px-4 py-2 md:py-4">
      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="px-8 pt-8 pb-10 space-y-6">
          {/* Error message */}
          {error && (
            <div className="bg-red-50 border-l-4 border-red-500 p-4 rounded-r text-red-700 text-sm">
              {error}
            </div>
          )}
