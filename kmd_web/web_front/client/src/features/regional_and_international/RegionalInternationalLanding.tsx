    ...
    //<PageLayout>
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <header ref={headerRef} className="mb-12">
          <h1 className="text-xl md:text-2xl font-serif font-bold text-primary mb-4">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {RegionalInternational.map((RegionalInternational) => (
            <Card key={RegionalInternational.slug} {...RegionalInternational} />
          ))}
        </div>
      </div>
    //</PageLayout>
