// src/features/forecasts/guidance/EAswfpDiscussion.tsx
...
const relatedLinks = [
  ...
  { href: "/guidance/marine-forecast-daily", label: "Marine Daily Forecast" },
...
export default function EAswfpDiscussion() {
  ...
  useEffect(() => {
    fetch("/api/forecasts/latest-doc/?slug=easwfp-discussion-daily")
      .then(res => {
      ...
      .then(data => {
        if (data?.document) {
          setDocumentPath(
            data.document.startsWith("/uploads/")
              ? data.document
      ...
      .catch(err => {
        console.error("Failed to fetch latest discussion:", err);
          ...
          <div className="lg:col-span-9">
            <header ref={headerRef} className="mb-6">
              ...
              <p className="text-lg text-gray-600 max-w-3xl">
                Daily EAswfp discussion document.
              </p>
            </header>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              {loading ? (
                ...
                <>
                  <iframe src={documentPath || ""} className="w-full h-[600px]" />
