      ...
      //<PageLayout>
        <div className="container mx-auto px-4 py-10 md:py-12 lg:py-16 max-w-6xl">
          <div className="text-center py-20">
            ...
            <p className="text-gray-600">Loading Marine Forecast Discussion...</p>
          </div>
        </div>
      //</PageLayout>
    );
          ...
          <div className="lg:col-span-9">
            <header ref= {headerRef} className="mb-6 md:mb-12">
              <h1 className="text-3xl md:text-4xl font-serif font-bold text-primary mb-4">
                 Marine Daily forecast Discussion
              </h1>
              <p className="text-lg text-gray-600 max-w-3xl">
                Daily Marine discussion document.
              </p>
            </header>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              {error ? (
                ...
                <FileViewer
                  ...
                  fileUrl={document_path || '/document.docx'}
                  fileType="docx"
                />
              )}
            </div>
