// src/features/forecasts/guidance/MarineForecastSevenDays.tsx
...
const relatedLinks = [
  { href: "/guidance/easwfp-discussion-daily", label: "EA SWFP Discussion" },
  { href: "/guidance/marine-forecast-daily", label: "Daily Marine Forecast" },
...
export default function MarineForecastSevenDays() {
  ...
  useEffect(() => {
    fetch("/api/forecasts/latest-doc/?slug=marine-forecast-seven-days")
      .then(res => {
      ...
      .catch(err => {
        console.error("Failed to fetch 7-day marine forecast:", err);
        ...
        <div className="lg:col-span-9">
          <header ref={headerRef} className="mb-6">
            <h1 className="text-3xl md:text-4xl font-serif font-bold text-primary mb-4">
              Marine Forecast Seven Day
            </h1>
            <p className="text-lg text-gray-600 max-w-3xl">
              Seven-day marine forecast discussion document.
            </p>
          </header>
            ...
            {loading ? (
              ...
              <>
                <iframe
                  ...
                  title="7-Day Marine Forecast Document"
                />
            ...
            <div className="space-y-1">
              {relatedLinks.map(link => (
                <SidebarLink
                  ...
                  href={link.href}
                  label={link.label}
                  isActive={link.href === "/guidance/marine-forecast-seven-days"}
                />
              ))}
            </div>
          </div>
