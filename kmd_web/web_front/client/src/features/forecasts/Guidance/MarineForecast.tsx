...
const relatedLinks = [
  { href: "/swfp-evaluation", label: "Guidance Landing" },
  { href: "/swfp-evaluation/marine-forecast", label: "Marine Forecast" },
];
              ...
              <div className="bg-white border rounded-xl p-6 shadow-sm">
                ...
                {relatedLinks.map(link => (
                  <SidebarLink
                    key={link.href}
                    {...link}
                    isActive={link.href === "/swfp-evaluation/easfwp-discussion"}
                  />
                ))}
              </div>
            </div>
