// src/features/forecasts/Shortrange/discussionshort.tsx
...
const SidebarLink = ({
  ...
  <Link href={href}>
    <div
      className={`block py-2.5 px-4 rounded-md transition-colors text-base
        ${
          isActive
      ...
      <div className="container mx-auto px-4 py-10 max-w-6xl">
        <div className="text-center py-20">
          ...
          <p className="text-gray-600">
            Loading Short Range Discussion...
          </p>
        </div>
      </div>
    );
              ...
              <div className="space-y-1">
                {relatedLinks.map((link) => (
                  <SidebarLink
                    key={link.href}
                    {...link}
                    isActive={link.href === "/forecasts/day-2"}
                  />
                ))}
              </div>
            </div>
