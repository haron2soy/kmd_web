...
//import React from "react";
  ...
  // Assume uploaded to /uploads/forecasts/short-range/discussion-short.doc
const FILE_PATH = "/uploads/forecasts/short-range/discussion-short.doc";
  ...
  export default function DiscussionShort() {
    return (
