      ...
      <div className="bg-slate-100 border-b border-slate-200 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="mt-4 text-slate-600 max-w-2xl text-lg">
            We are here to assist you with any meteorological inquiries. Please reach out to us
            using the form below or our direct contact details.
          </p>
        </div>
      </div>
                ...
                <form className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input placeholder="John Doe" className="rounded-sm" />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input type="email" placeholder="john@example.com" className="rounded-sm" />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input placeholder="Inquiry regarding..." className="rounded-sm" />
                  </div>
                  ...
                  <Button
                    type="button"
                    className="w-full bg-primary hover:bg-primary/90 rounded-sm font-bold h-12"
                  >
                    Submit Inquiry
                  </Button>
